/* imports_fruitninja_extra.c -- the import surface FRUIT NINJA CLASSIC + needs
 ...
 *   extern DynLibFunction fruitninja_extra_functions[];
 ...
 * naive "swap imports_pvz_extra.c for imports_fruitninja_extra.c" would delete
...
/* ---- resolver table ----------------------------------------------------- */
DynLibFunction fruitninja_extra_functions[] = {
...
size_t fruitninja_extra_numfunctions =
    sizeof(fruitninja_extra_functions) / sizeof(fruitninja_extra_functions[0]);
